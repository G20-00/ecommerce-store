...
// Configura tu Key Vault y la identidad administrada
const keyVaultName = "passwordredisauto"; // Nombre del Key Vault
const keyVaultUrl = `https://${keyVaultName}.vault.azure.net`;

// Crear un cliente de Key Vault
...
async function initializeSecrets() {
  try {
    ...
    // Imprimir las claves para verificar que se obtienen correctamente
